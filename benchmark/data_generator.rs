...
pub fn gem_identity_variants() -> [(&'static str, &'static str, &'static str); 2] {
    [
        ("empty_identity", "", ""),
        ("populated_identity", "SECS-SIMULATOR", "1.0.0"),
    ]
}

pub fn gem_representative_configs() -> Vec<(&'static str, StateMachineConfig)> {
    vec![
        ("default", StateMachineConfig::default()),
        (
            "remote_online_default",
            StateMachineConfig {
...
pub fn gem_transition_scenarios() -> Vec<(&'static str, DeviceState, StateMachineConfig, Vec<StateEvent>)> {
    vec![
        (
            ...
            StateMachineConfig::default(),
            vec![StateEvent::SocketConnectedEvent, StateEvent::SelectEvent],
        ),
        (
            ...
            vec![
                ...
                StateEvent::OperatorSetsRemoteEvent,
            ],
        ),
        (
        ...
        (
            ...
            vec![StateEvent::ReceivedS1F17Event],
        ),
        (
            "mixed_twelve_event_flow",
            DeviceState::NotConnected,
            StateMachineConfig::default(),
            vec![
                StateEvent::SocketConnectedEvent,
                ...
                StateEvent::SocketDisconnectedEvent,
                StateEvent::SocketConnectedEvent,
                StateEvent::SelectEvent,
            ],
        ),
...
pub fn gem_high_frequency_events() -> Vec<StateEvent> {
    let cycle = [
        StateEvent::SocketConnectedEvent,
        StateEvent::SelectEvent,
        StateEvent::OperatorActuatesOnlineEvent,
    ...
    cycle.into_iter().cycle().take(1_000).collect()
}